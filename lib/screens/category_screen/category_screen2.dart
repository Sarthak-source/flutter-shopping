        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              //Text(controller.Subcategories2.toString()),
              Expanded(
                ...
                itemCount: widget.subCatId != null
                    ? controller.Subcategories2.length
                    : controller.categories.length,
                itemBuilder: (BuildContext context, int index) {
                  var subCatData = widget.subCatId != null
                      ? controller.Subcategories2[index]
                      : null;
                  return InkWell(
                    onTap: () {
                      if (widget.subCatId != null) {
                    ...
                    //child: Text(subCatData.toString()),
