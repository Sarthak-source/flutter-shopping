 const String termsAndConditionsHtml = '''
    ...
    <body>
        ...
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Dilicia if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By accessing Dilicia, you agreed to use cookies in agreement with the Company Name's Privacy Policy.</p>
        <p>Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
        <h2>License</h2>
        <p>Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Dilicia. All intellectual property rights are reserved. You may access this from Dilicia for your own personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from Dilicia</li>
            <li>Sell, rent or sub-license material from Dilicia</li>
            <li>Reproduce, duplicate or copy material from Dilicia</li>
            <li>Redistribute content from Dilicia</li>
        </ul>
